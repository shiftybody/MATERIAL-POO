...
public class GourmetCoffee extends Catalog {
    ...
    public void displayCatalog() {
        ...
        if (size == 0) {
            ...
            for (Iterator i = catalog.iterator(); ((Iterator<?>) i).hasNext();) {
    ...
    public void displayNumberOfOrders(Product product) {
        ...
        stdOut.println("El numero de ordenes que contienen el producto "+
                product.getCode()+" son: "+numeroDeOrdenes);
        stdOut.flush();
